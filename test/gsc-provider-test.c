...
#define GSC_PROVIDER_TEST_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), TYPE_GSC_PROVIDER_TEST, GtkSourceCompletionProviderTestPrivate))
...
static GtkSourceCompletionProviderIface* 
...
static void
gsc_provider_test_interface_init (GtkSourceCompletionProviderIface *iface)
{
...
GType gsc_provider_test_get_type ()
{
	...
	if (G_UNLIKELY (g_define_type_id == 0)) {
		...
		g_define_type_id = g_type_register_static (G_TYPE_OBJECT, "GtkSourceCompletionProviderTest", &g_define_type_info, 0);
		...
		g_type_add_interface_static (g_define_type_id, GTK_TYPE_SOURCE_COMPLETION_PROVIDER, &gsc_provider_info);
	}
