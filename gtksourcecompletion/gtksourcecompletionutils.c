					   ...
					   GtkTextIter     *end_word)
{
	...
	text_buffer = GSC_TEXT_BUFFER (source_buffer);
              ...
              gint          *height)
{
	...
	text_view = GSC_TEXT_VIEW (source_view);
	...
	win = gtk_text_view_get_window (text_view, GSC_TEXT_WINDOW_WIDGET);
					  ...
					  gint             len)
{
	...
	g_return_if_fail (GSC_IS_SOURCE_BUFFER (source_buffer));
	
	buffer = GSC_TEXT_BUFFER (source_buffer);
						  ...
						  gint             len)
{
	...
	mark = gtk_text_buffer_get_insert (GSC_TEXT_BUFFER (source_buffer));
	gtk_text_buffer_get_iter_at_mark (GSC_TEXT_BUFFER (source_buffer),
	                                  &iter,
	                                  mark);
