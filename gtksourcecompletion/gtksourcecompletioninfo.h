...
#define GSC_TYPE_SOURCE_COMPLETION_INFO             (gsc_completion_info_get_type ())
#define GSC_COMPLETION_INFO(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), GSC_TYPE_SOURCE_COMPLETION_INFO, GscInfo))
#define GSC_COMPLETION_INFO_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST ((klass), GSC_TYPE_SOURCE_COMPLETION_INFO, GscInfoClass)
#define GSC_IS_SOURCE_COMPLETION_INFO(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GSC_TYPE_SOURCE_COMPLETION_INFO))
#define GSC_IS_SOURCE_COMPLETION_INFO_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE ((klass), GSC_TYPE_SOURCE_COMPLETION_INFO))
#define GSC_COMPLETION_INFO_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS ((obj), GSC_TYPE_SOURCE_COMPLETION_INFO, GscInfoClass))
