...
#define GSC_TYPE_SOURCE_COMPLETION_PROVIDER 			(gsc_completion_provider_get_type ())
#define GSC_COMPLETION_PROVIDER(obj) 			(G_TYPE_CHECK_INSTANCE_CAST ((obj), GSC_TYPE_SOURCE_COMPLETION_PROVIDER, GscProvider))
#define GSC_IS_SOURCE_COMPLETION_PROVIDER(obj) 			(G_TYPE_CHECK_INSTANCE_TYPE ((obj), GSC_TYPE_SOURCE_COMPLETION_PROVIDER))
#define GSC_COMPLETION_PROVIDER_GET_INTERFACE(obj) 	(G_TYPE_INSTANCE_GET_INTERFACE ((obj), GSC_TYPE_SOURCE_COMPLETION_PROVIDER, GscProviderIface))
