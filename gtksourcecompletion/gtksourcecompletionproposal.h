...
#define GSC_TYPE_SOURCE_COMPLETION_PROPOSAL			(gsc_completion_proposal_get_type ())
#define GSC_COMPLETION_PROPOSAL(obj)			(G_TYPE_CHECK_INSTANCE_CAST ((obj), GSC_TYPE_SOURCE_COMPLETION_PROPOSAL, GscProposal))
#define GSC_IS_SOURCE_COMPLETION_PROPOSAL(obj)			(G_TYPE_CHECK_INSTANCE_TYPE ((obj), GSC_TYPE_SOURCE_COMPLETION_PROPOSAL))
#define GSC_COMPLETION_PROPOSAL_GET_INTERFACE(obj)	(G_TYPE_INSTANCE_GET_INTERFACE ((obj), GSC_TYPE_SOURCE_COMPLETION_PROPOSAL, GscProposalIface))
