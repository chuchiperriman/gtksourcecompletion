...
{
	g_return_val_if_fail (GSC_IS_SOURCE_COMPLETION_PROPOSAL (proposal), 0);
...
gsc_completion_proposal_equals (GscProposal *proposal1,
				       GscProposal *proposal2)
{
	g_return_val_if_fail (GSC_IS_SOURCE_COMPLETION_PROPOSAL (proposal1), FALSE);
	g_return_val_if_fail (GSC_IS_SOURCE_COMPLETION_PROPOSAL (proposal2), FALSE);
