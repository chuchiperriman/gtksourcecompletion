...
#define GSC_TYPE_SOURCE_COMPLETION_MODEL		(gsc_completion_model_get_type ())
#define GSC_COMPLETION_MODEL(obj)		(G_TYPE_CHECK_INSTANCE_CAST ((obj), GSC_TYPE_SOURCE_COMPLETION_MODEL, GscModel))
#define GSC_COMPLETION_MODEL_CONST(obj)		(G_TYPE_CHECK_INSTANCE_CAST ((obj), GSC_TYPE_SOURCE_COMPLETION_MODEL, GscModel const))
#define GSC_COMPLETION_MODEL_CLASS(klass)	(G_TYPE_CHECK_CLASS_CAST ((klass), GSC_TYPE_SOURCE_COMPLETION_MODEL, GscModelClass))
#define GSC_IS_SOURCE_COMPLETION_MODEL(obj)		(G_TYPE_CHECK_INSTANCE_TYPE ((obj), GSC_TYPE_SOURCE_COMPLETION_MODEL))
#define GSC_IS_SOURCE_COMPLETION_MODEL_CLASS(klass)	(G_TYPE_CHECK_CLASS_TYPE ((klass), GSC_TYPE_SOURCE_COMPLETION_MODEL))
#define GSC_COMPLETION_MODEL_GET_CLASS(obj)	(G_TYPE_INSTANCE_GET_CLASS ((obj), GSC_TYPE_SOURCE_COMPLETION_MODEL, GscModelClass))
