...
HELP = USAGE + """
generate skeleton source tree for a new GscProposal.
...
output_files['proposal-template.c'] = '%s/gsc-proposal-%s.c' % (plugin_module, plugin_module)
output_files['proposal-template.h'] = '%s/gsc-proposal-%s.h' % (plugin_module, plugin_module)
